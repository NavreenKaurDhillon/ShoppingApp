...
class ProductAdapter(private val isHorizontal: Boolean = false) : ListAdapter<Product, RecyclerView.ViewHolder>(DiffCallback()) {
    ...
    class CardViewHolder(private val binding: ItemProductCardBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    class HorizontalViewHolder(private val binding: ItemProductHorizontalBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(product: Product) {
